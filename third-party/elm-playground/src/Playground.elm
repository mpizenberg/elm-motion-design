module Playground exposing
    ...
    , Number
    , Animation, Game, Msg, render, toScreen
    )
...
picture shapes =
    let
        ...
        view screen =
            { title = "Playground"
            , body = [ render "playground" screen shapes ]
            }
...
animation viewFrame =
    let
        ...
        view (Animation _ screen time) =
            { title = "Playground"
            , body = [ render "playground" screen (viewFrame time) ]
            }
...
game viewMemory updateMemory initialMemory =
    let
        ...
        view (Game _ memory computer) =
            { title = "Playground"
            , body = [ render "playground" computer.screen (viewMemory computer memory) ]
            }
...
render : String -> Screen -> List Shape -> Html.Html msg
render id screen shapes =
    let
        w =
